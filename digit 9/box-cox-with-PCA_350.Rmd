...
```{r}
# Load the dataset
data <- read.csv("pca_data_350.csv")  # Update with the actual CSV file name
...
# 创建一个数据框
summary_df <- data.frame(Coefficients = rownames(coefficients_table),
                         Estimate = coefficients_table[, 1],
                         Std.Error = coefficients_table[, 2],
                         t.value = coefficients_table[, 3],
                         p.value = coefficients_table[, 4])

# 添加 R2 和 Adjusted R2 到数据框
summary_df <- rbind(summary_df, c("R-squared", r_squared, NA, NA, NA),
                                c("Adjusted R-squared", adj_r_squared, NA, NA, NA))

# 将数据框导出为CSV文件
write.csv(summary_df, "model_summary_350.csv", row.names = FALSE)

```

```{r}
model_3 = lm(pred_prob ~ f_300+f_301+f_302+f_303+f_304+f_305+f_306+f_307+f_308+f_309+f_310+f_311+f_312+f_313+f_314+f_315+f_316+f_317+f_318+f_319+f_320+f_321+f_322+f_323+f_324+f_325+f_326+f_327+f_328+f_329+f_330+f_331+f_332+f_333+f_334+f_335+f_336+f_337+f_338+f_339+f_340+f_341+f_342+f_343+f_344+f_345+f_346+f_347+f_348+f_349+f_350, data = normalized_data)
summary(model_3)
```
