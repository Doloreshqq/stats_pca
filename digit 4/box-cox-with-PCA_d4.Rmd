...
```{r}
# Load the dataset
d1 <- read.csv("pca_data_20_d4.csv") 
d2 <- read.csv("pca_data_40_d4.csv") 
d3 <- read.csv("pca_data_60_d4.csv") 
d4 <- read.csv("pca_data_80_d4.csv") 
d5 <- read.csv("pca_data_100_d4.csv") 
d6 <- read.csv("pca_data_120_d4.csv") 
d7 <- read.csv("pca_data_140_d4.csv") 
d8 <- read.csv("pca_data_160_d4.csv") 
d9 <- read.csv("pca_data_180_d4.csv") 
d10 <- read.csv("pca_data_200_d4.csv") 
d11 <- read.csv("pca_data_250_d4.csv") 
d12 <- read.csv("pca_data_300_d4.csv")
d13 <- read.csv("pca_data_350_d4.csv")
d14 <- read.csv("pca_data_400_d4.csv")
...
plot <- ggplot(dp, aes(x=pca)) +
  ...
  labs(title="R2 and Adjusted R2 vs PCA for digit 4",
       x="PCA",
       y="R2 / Adjusted R2") +
  theme_minimal() +
