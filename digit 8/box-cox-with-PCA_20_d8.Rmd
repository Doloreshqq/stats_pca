...
```{r}
# Load the dataset
data <- read.csv("pca_data_20_d8.csv")  # Update with the actual CSV file name
...
```{r}
model_2  = lm(pred_prob ~ f_1+f_2+f_3+f_4+f_5+f_6+f_7+f_8+f_9+f_10+f_11+f_12+f_13+f_14+f_15+f_16+f_17+f_18+f_19+f_20, data = normalized_data)
summary(model_2)
```
