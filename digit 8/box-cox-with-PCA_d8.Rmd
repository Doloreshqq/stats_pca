...
```{r}
# Load the dataset
d1 <- read.csv("pca_data_1_d8.csv")
d2 <- read.csv("pca_data_2_d8.csv") 
d3 <- read.csv("pca_data_3_d8.csv") 
d4 <- read.csv("pca_data_5_d8.csv") 
d5 <- read.csv("pca_data_10_d8.csv") 
d6 <- read.csv("pca_data_20_d8.csv") 
d7 <- read.csv("pca_data_40_d8.csv")
d8 <- read.csv("pca_data_50_d8.csv") 
d9 <- read.csv("pca_data_60_d8.csv") 
d10 <- read.csv("pca_data_80_d8.csv") 
d11 <- read.csv("pca_data_100_d8.csv") 
d12 <- read.csv("pca_data_120_d8.csv") 
d13 <- read.csv("pca_data_140_d8.csv")
d14 <- read.csv("pca_data_150_d8.csv") 
d15 <- read.csv("pca_data_160_d8.csv") 
d16 <- read.csv("pca_data_180_d8.csv") 
d17 <- read.csv("pca_data_200_d8.csv") 
d18 <- read.csv("pca_data_250_d8.csv") 
d19 <- read.csv("pca_data_300_d8.csv")
d20 <- read.csv("pca_data_350_d8.csv")
d21 <- read.csv("pca_data_400_d8.csv")
...
ggplot(dp,aes(x=pca))+
  geom_line(aes(y=AIC))+
  labs(title="AIC vs PCA for digit 8",
       x="PCA",
       y="AIC") +
  theme_minimal()
