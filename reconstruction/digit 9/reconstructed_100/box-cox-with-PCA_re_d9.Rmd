...
```{r}
# Load the dataset
d1 <- read.csv("pca_data_re_20_d9.csv") 
d2 <- read.csv("pca_data_re_40_d9.csv") 
d3 <- read.csv("pca_data_re_60_d9.csv") 
d4 <- read.csv("pca_data_re_80_d9.csv") 
d5 <- read.csv("pca_data_re_100_d9.csv") 
d6 <- read.csv("pca_data_re_120_d9.csv") 
d7 <- read.csv("pca_data_re_140_d9.csv") 
d8 <- read.csv("pca_data_re_160_d9.csv") 
d9 <- read.csv("pca_data_re_180_d9.csv") 
d10 <- read.csv("pca_data_re_200_d9.csv") 
d11 <- read.csv("pca_data_re_250_d9.csv") 
d12 <- read.csv("pca_data_re_300_d9.csv")
d13 <- read.csv("pca_data_re_350_d9.csv")
d14 <- read.csv("pca_data_re_400_d9.csv")
