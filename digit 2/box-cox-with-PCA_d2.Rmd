...
d1 <- read.csv("pca_data_1_d2.csv")
d2 <- read.csv("pca_data_2_d2.csv") 
d3 <- read.csv("pca_data_3_d2.csv") 
d4 <- read.csv("pca_data_5_d2.csv") 
d5 <- read.csv("pca_data_10_d2.csv") 
d6 <- read.csv("pca_data_20_d2.csv") 
d7 <- read.csv("pca_data_40_d2.csv")
d8 <- read.csv("pca_data_50_d2.csv") 
d9 <- read.csv("pca_data_60_d2.csv") 
d10 <- read.csv("pca_data_80_d2.csv") 
d11 <- read.csv("pca_data_100_d2.csv") 
d12 <- read.csv("pca_data_120_d2.csv") 
d13 <- read.csv("pca_data_140_d2.csv")
d14 <- read.csv("pca_data_150_d2.csv") 
d15 <- read.csv("pca_data_160_d2.csv") 
d16 <- read.csv("pca_data_180_d2.csv") 
d17 <- read.csv("pca_data_200_d2.csv") 
d18 <- read.csv("pca_data_250_d2.csv") 
d19 <- read.csv("pca_data_300_d2.csv")
d20 <- read.csv("pca_data_350_d2.csv")
d21 <- read.csv("pca_data_400_d2.csv")
...
plot <- ggplot(dp, aes(x=pca)) +
  ...
  labs(title="R2 and Adjusted R2 vs PCA for digit 2",
       x="PCA",
       y="R2 / Adjusted R2") +
  theme_minimal() +
...
ggplot(dp,aes(x=pca))+
  geom_line(aes(y=AIC))+
  labs(title="AIC vs PCA for digit 2",
       x="PCA",
       y="AIC") +
  theme_minimal()
